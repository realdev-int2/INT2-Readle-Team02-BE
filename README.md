...
- 답안을 제출하면 AI 채점과 피드백을 제공하고, 정답 수·정답률·풀이 시간 기반의 결과 리포트를 만든다.
- 대시보드에서 누적 학습 현황과 태그별 진행도를 조회할 수 있다.
...
| 백엔드 연동 | 학습 현황·히스토리·결과 리포트 API와 태그 저장 기능 구현 |
